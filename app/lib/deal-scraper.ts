...
export function getSampleDeals(): ScrapedDeal[] {
  return [
    ...
    },
    {
      ...
      source: "JackFlightClub",
      url: "https://jacksflightclub.com/london-dubai-deal",
      confidence: "high",
    },
    {
      ...
      dates: "July 2025",
      source: "SecretFlying",
      url: "https://secretflying.com/london-singapore-deal",
      confidence: "high",
    },
    {
      route: "Edinburgh to Amsterdam",
      from: "EDI",
      to: "AMS",
      price: 45,
      currency: "GBP",
      dates: "Various",
      source: "Fly4Free",
      url: "https://fly4free.com/edinburgh-amsterdam-deal",
      confidence: "medium",
    },
    {
      route: "London to Los Angeles",
      from: "LHR",
      to: "LAX",
      price: 320,
      currency: "GBP",
      ...
      source: "SecretFlying",
      url: "https://secretflying.com/london-la-deal",
      confidence: "high",
    },
    {
      route: "Birmingham to Barcelona",
      from: "BHX",
      to: "BCN",
      price: 35,
      currency: "GBP",
      dates: "Spring 2025",
      source: "Fly4Free",
      url: "https://fly4free.com/birmingham-barcelona-deal",
      confidence: "medium",
    },
  ];
}
